$(function() {
    altair_datatables.dt_default(), altair_datatables.dt_scroll(), altair_datatables.dt_individual_search(), altair_datatables.dt_colVis(), altair_datatables.dt_tableTools(), altair_datatables.dt_pending(), altair_datatables.dt_approved(), altair_datatables.dt_denied()
}), altair_datatables = {
    dt_default: function() {
        var t = $("#dt_default");
