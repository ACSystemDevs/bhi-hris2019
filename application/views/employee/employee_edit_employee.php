<div id="page_content">
    <div id="page_content_inner">
        <form enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>Employee-Update-Employee-Function/<?php echo $profile->PK_employee_code;?>" class="uk-form-stacked" id="user_edit_form">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <div class="uk-form-row">
                                                ...
                                                <input class="md-input uk-text-upper" type="text" id="basic_birthdate" name="emp_birthdate" data-uk-datepicker="{format:'MM/DD/YYYY'}" value="<?php echo $profile->emp_birthdate;?>" disabled>
                                            </div>
                                            <div class="uk-form-row">
                                                        ...
                                                        if($profile->emp_gender == 'MALE'){
                                                            echo '<span class="icheck-inline">
                                                                ...
                                                                <span class="icheck-inline">
                                                                        <input type="radio" name="emp_gender" id="radio_gender_female" value="FEMALE" data-md-icheck disabled/>
                                                                        <label for="radio_gender_female" class="inline-label">FEMALE</label>
                                                                    </span>';
                                                        }else{
                                                            echo '<span class="icheck-inline">
                                                                        <input type="radio" name="emp_gender" id="radio_gender_male" value="MALE" data-md-icheck disabled/>
                                                                        <label for="radio_gender_male" class="inline-label">MALE</label>
                                                                    </span>
                                                                <span class="icheck-inline">
                                        ...
                                        <div class="uk-width-medium-1-2">
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>CTC No.</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_ctc" minlength="8" maxlength="8" value="<?php echo $profile->CTC_No;?>" disabled/>
                                                    </div>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>CTC Date</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_ctc_date" data-uk-datepicker="{format:'MM/DD/YYYY'}" value="<?php echo $profile->CTC_Date;?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>PRC</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_prc_license" maxlength="7" value="<?php echo $profile->PRC_License;?>" disabled/>
                                                    </div>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>PRC Expiration Date</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_prc_expire" data-uk-datepicker="{format:'MM/DD/YYYY'}" value="<?php echo $profile->PRC_Expdate;?>" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-form-row">
                                                <label>TIN</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_tin_id" minlength="13" maxlength="13" value="<?php echo preg_replace("/^1?(\d{3})(\d{3})(\d{3})(\d{4})$/", "$1-$2-$3-$4", $profile->TIN_ID);?>" disabled/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>SSS</label>
                                               
                                                <input type="text" class="md-input uk-text-upper" name="emp_sss_id" minlength="10" maxlength="10" value=" <?php echo preg_replace("/^1?(\d{2})(\d{7})(\d{1})$/", "$1-$2-$3", $profile->SSS_ID);?>" disabled/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Philhealth</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_phic_id" minlength="12" maxlength="12" value="<?php echo preg_replace("/^1?(\d{4})(\d{4})(\d{4})$/", "$1-$2-$3", $profile->PHIC_ID);?>" disabled/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Pag-ibig</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_hdmf_id" minlength="12" maxlength="12" value="<?php echo preg_replace("/^1?(\d{4})(\d{4})(\d{4})$/", "$1-$2-$3", $profile->HDMF_ID);?>" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
