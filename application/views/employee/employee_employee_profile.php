                ...
                <div class="md-card">
                    ...
                    <div class="user_content">
                        <ul id="user_profile_tabs" class="uk-tab" data-uk-tab="{connect:'#user_profile_tabs_content', animation:'slide-horizontal'}" data-uk-sticky="{ top: 48, media: 960 }">
                            <?php 
                                if ((is_array(unserialize(base64_decode($profile->record_status))) && count(unserialize(base64_decode($profile->record_status))) > 0 && unserialize(base64_decode($profile->record_status))[0] != '')) {
                                    ...
                                    $emp_status =  unserialize(base64_decode($profile->record_status))[$rec_count];
                                    if($emp_status == 'Regular'){
                                        echo '<li class="uk-active"><a href="#">Personal Information</a></li>
                        ...
                        <ul id="user_profile_tabs_content" class="uk-switcher uk-margin">
                            <li>
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Personal Details</h4>
                                <ul class="md-list">
                                    <li>
                                ...
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Government IDs</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Family Background</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <hr/>
                                <!-- END OF Family -->
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Work Experience</h4>
                                                                ...
                                                                if (is_array(unserialize(base64_decode($profile->experience_firm))) && count(unserialize(base64_decode($profile->experience_firm))) > 0 && unserialize(base64_decode($profile->experience_firm))[0] != '') {
                                                                    ...
                                                                    for ($i = 0; $i < $exp; $i++) {
                                                                        echo '<tr>
                                                                                ...
                                                                                <td>
                                                                                    '.date('F d, Y',strtotime(unserialize(base64_decode($profile->experience_sdate))[$i])).' to '.date('F d, Y',strtotime(unserialize(base64_decode($profile->experience_edate))[$i])).'
                                                                                </td>
                                                                                <td>
                                ...
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Education</h4>
                                <div class="uk-overflow-container">
                                    <table class="uk-table uk-table-hover">
                                        <thead>
                                            <tr>
                                ...
                                <div id="spouse_div" <?php if($profile->emp_civilstatus == 'Married'){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>>
                                    <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Spouse</h4>
                                    <ul class="md-list">
                                        <li>
                                            <div class="md-list-content">
                                                <span class="md-list-heading">
                                ...
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Dependents</h4>
                                <div class="uk-overflow-container">
                            ...
                            <li>
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Work</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <hr/>
                                <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Service Record</h4>
                                <div class="uk-overflow-container">
                            ...
                            <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Leave Credit for <?php echo date('Y');?></h4>
                            ...
                            <h4 class="full_width_in_card heading_c uk-margin-small-bottom ">Leave History</h4>
