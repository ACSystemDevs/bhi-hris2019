                            ...
                            <div class="uk-form-row">
                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-1-4">
                                        ...
                                        <input type="text" class="md-input uk-text-upper" name="emp_LName" value="<?php echo set_value('emp_LName');?>" autocomplete="off" />
                                    </div>
                                    <div class="uk-width-medium-1-4">
                                        <label>First Name</label>
                                        <input type="text" class="md-input uk-text-upper" name="emp_FName" value="<?php echo set_value('emp_LName');?>" autocomplete="off"/>
                                    </div>
                                    <div class="uk-width-medium-1-4">
                                        <label>Middle Name</label>
                                        <input type="text" class="md-input uk-text-upper" name="emp_MName" value="<?php echo set_value('emp_LName');?>" autocomplete="off"/>
                                    </div>
                                    <div class="uk-width-medium-1-4">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <div class="uk-form-row">
                                                ...
                                                <input class="md-input uk-text-upper" type="text" id="basic_birthdate" name="emp_birthdate" data-uk-datepicker="{format:'MM/DD/YYYY'}" autocomplete="off">
                                            </div>
                                            <div class="uk-form-row">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-2">
                                            <div class="uk-form-row">
                                                ...
                                                <input type="text" class="md-input uk-text-upper" name="emp_mobile_no" maxlength="11" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label for="">Telephone No.</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_telephone_no" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Email Address</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_email_address" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <div class="md-card">
                                        ...
                                        <div class="uk-width-medium-1-2">
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>CTC No.</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_ctc" maxlength="8" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>CTC Date</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_ctc_date" data-uk-datepicker="{format:'MM/DD/YYYY'}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>PRC</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_prc_license" maxlength="7" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label>PRC Expiration Date</label>
                                                        <input type="text" class="md-input uk-text-upper" name="emp_prc_expire" data-uk-datepicker="{format:'MM/DD/YYYY'}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>TIN</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_tin_id" minlength="13" maxlength="13" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>SSS</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_sss_id" minlength="10" maxlength="10" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Philhealth</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_phic_id" minlength="12" maxlength="12" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Pag-ibig</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_hdmf_id" minlength="12" maxlength="12" autocomplete="off"/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
