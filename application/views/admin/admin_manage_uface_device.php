        ...
        <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show" data-uk-sortable data-uk-grid-margin>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        ...
                        <span class="uk-text-muted uk-text-small">Last Synced on</span>
            ...
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="material-icons md-color-teal-500 md-36">event_available</i></div>
                        <span class="uk-text-muted uk-text-small">Current Time</span>
                        <h2 class="uk-margin-remove">
            ...
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <button type="button" class="md-btn md-btn-primary md-btn-wave-light md-btn-block" data-uk-tooltip title="SYNC TIME WITH TERMINAL" style="height:50px;" onclick="sync_time_terminal()" ><i class="material-icons md-color-grey-50 md-24">watch</i>&nbsp;Sync Time</button>
                    </div>
                </div>
            </div>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <button type="button" class="md-btn md-btn-primary md-btn-wave-light md-btn-block" data-uk-tooltip title="SYNCING TAKES TIME" style="height:50px;" onclick="sync_records()" ><i class="material-icons md-color-grey-50 md-24">sync</i>&nbsp;Sync Data</button>
                    </div>
                </div>
            </div>
        </div>
