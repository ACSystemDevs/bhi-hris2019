                                            ...
                                            <?php 
                                                                if (is_array(unserialize(base64_decode($profile->emp_dep_LName))) && count(unserialize(base64_decode($profile->emp_dep_LName))) > 0 && unserialize(base64_decode($profile->emp_dep_LName))[0] != '') {
                                                                    ...
                                                                    for ($i = 0; $i < $exp; $i++) {
                                                                        ...
                                                                        $dep_birthday           = date('Y-m-d',strtotime(unserialize(base64_decode($profile->emp_dep_birthdate))[$i]));
                                                                $today              = date('Y-m-d');
                                                                list($y1, $m1, $d1) = explode('-', $dep_birthday);
                                                                list($y2, $m2, $d2) = explode('-', $today);
                                                                $m1                 = $m2 - $m1;
                                                                ...
                                                                $age = $y2 - $y1;
                                                                $age = floor((time() - strtotime($dep_birthday)) / 31556926);
                                                                $datetime = date_diff(date_create(), date_create($dep_birthday));
                                                                $d_age      = $datetime->format('%Y years, %m months Old');
                                                                        echo '<tr>
                                                                                <td>
                                                                                    '.$dep_wname.'
                                                                                </td>
                                                        ...
                                                        <?php   
                                                            ...
                                                            for ($i = 0; $i < $rows; $i++) {
                                                                ...
                                                                if ((($past_att_log[$i]["Att_TimeIn"]) == 'OFF') && (($past_att_log[$i]["Att_TimeOut"]) == 'OFF')) {
                                                                    ...
                                                                    if ($past_att_log[$i]['Att_TimeMisc1']) {
                                                                        $time_miscs1 = date('h:i:sA', strtotime($past_att_log[$i]['Att_TimeMisc1']));
                                                                    }
                                                                }
                                                                echo '<tr>
