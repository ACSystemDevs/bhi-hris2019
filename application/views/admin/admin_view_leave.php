        ...
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                ...
                <ul id="employee_leave_request" class="uk-tab" data-uk-tab="{connect:'#employee_leave_request_content', animation:'slide-horizontal'}" data-uk-sticky="{ top: 48, media: 960 }">
                    <!-- <li class="uk-active"><a href="#"><span class="uk-badge uk-badge-notification uk-badge-primary">All</span></a></li> -->
                                ...
                                <?php
                                        foreach($leave_request as $request){
                                            ...
                                            if($request->Leave_Status == 'Pending' || $request->Leave_Status == 'Recommended' || $request->Leave_Status == 'Approved'){
                                                ...
                                                $buttons = '<button class="md-btn md-btn-primary md-btn-wave-light md-btn-small" data-uk-tooltip title="VIEW LEAVE" onclick="modal_view_leave_details(' . "'" . $request->PK_request_ID . "'" . ')"><i class="material-icons md-color-grey-50 md-24">visibility</i></button>
                                                            <button class="md-btn md-btn-danger md-btn-wave-light md-btn-small" data-uk-tooltip title="DISAPPROVE LEAVE" onclick="modal_leave_disapprove_noted(' . "'" . $request->PK_request_ID . "','" . $request->PK_employee_code . "','" . $request->PK_leave_ID . "'" .')"><i class="material-icons md-color-grey-50 md-24">close</i></button>';
                                            }else{
