                                ...
                                <div class="uk-grid uk-dropdown-grid" data-uk-grid-margin>
                                    <div class="uk-width-2-3">
                                        <div class="uk-grid uk-grid-width-medium-1-3 uk-margin-top uk-margin-bottom uk-text-center" data-uk-grid-margin>
                                            <a href="<?php echo base_url();?>Employee-Masterlist">
                                                <i class="material-icons md-36 md-color-blue-600">face</i>
                                                <span class="uk-text-muted uk-display-block">Employees</span>
                                            </a>
                                            <a href="<?php echo base_url();?>Leave-Application">
                                                <i class="material-icons md-36 md-color-orange-600">contact_mail</i>
                                                <span class="uk-text-muted uk-display-block">Leave</span>
                                            </a>
                                            <a href="<?php echo base_url();?>Employee-Attendance">
                                                <i class="material-icons md-36 md-color-red-600">watch_later</i>
                                                <span class="uk-text-muted uk-display-block">Attendance</span>
                                            </a>
                                            <a href="<?php echo base_url();?>Manage-Users">
                                                <i class="material-icons md-36 md-color-green-600">supervisor_account</i>
                                                <span class="uk-text-muted uk-display-block">Users</span>
                                            </a>
                                            <a href="<?php echo base_url();?>Manage-Position">
                                                <i class="material-icons md-36 md-color-deep-purple-600">school</i>
                                                <span class="uk-text-muted uk-display-block">Position</span>
                                            </a>
                                            <a href="<?php echo base_url();?>Customized-Report">
                                                <i class="material-icons md-36 md-color-teal-600">folder</i>
                                                <span class="uk-text-muted uk-display-block">Reports</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="uk-width-1-3">
                                        <ul class="uk-nav uk-nav-dropdown uk-panel">
                                            <li class="uk-nav-header">Common Modules</li>
                                            <!--<li><a href="components_accordion.html">View Employees</a></li>
                                            <li><a href="components_buttons.html">View Leave</a></li>
                                            <li><a href="components_notifications.html">View Records</a></li>
                                            <li><a href="components_tabs.html">View Users</a></li>
                                            <li><a href="components_tabs.html">Reports</a></li>-->
                                        </ul>
                                    </div>
                                </div>
                            </div>
