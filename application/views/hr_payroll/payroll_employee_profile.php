                ...
                <div class="md-card">
                        ...
                        <div class="md-fab-wrapper">
                            <div class="md-fab md-fab-toolbar md-fab-small md-fab-accent">
                                ...
                                <div class="md-fab-toolbar-actions">
                                    <a href="<?php echo base_url();?>Edit-Employee/<?php echo $profile->PK_employee_code;?>" type="submit" id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Edit Profile"><i class="material-icons md-color-white">edit</i></a>
                                    <a href="<?php echo base_url();?>Upload-File/<?php echo $profile->PK_employee_code;?>" type="submit" id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Upload Document"><i class="material-icons md-color-white">cloud_upload</i></a>
                                    <a href="<?php echo base_url();?>Request-Leave/<?php echo $profile->PK_employee_code;?>" type="submit" id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Request Leave"><i class="material-icons md-color-white">event_busy</i></a>
                                    <a href="<?php echo base_url();?>Edit-Employee/<?php echo $profile->PK_employee_code;?>" type="submit" id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Print"><i class="material-icons md-color-white">print</i></a>
                                    <a href="<?php echo base_url();?>Edit-Employee/<?php echo $profile->PK_employee_code;?>" type="submit" id="user_edit_save" data-uk-tooltip="{cls:'uk-tooltip-small',pos:'bottom'}" title="Mark as Inactive"><i class="material-icons md-color-white">close</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="user_content">
                        ...
                        <ul id="user_profile_tabs_content" class="uk-switcher uk-margin">
                            <li>
                                <h4 class="heading_b uk-margin-small-bottom ">Personal Details</h4>
                                <ul class="md-list">
                                    <li>
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-large-1-2">
                                                    <span class="md-list-heading">
                                                                ...
                                                                $age      = $datetime->format('%Y years, %m months, %d days Old');
                                                                echo $age;
                                                                ?>
                                                                </span>
                                ...
                                <h4 class="heading_b uk-margin-small-bottom ">Government IDs</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <h4 class="heading_b uk-margin-small-bottom ">Family Background</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <hr/>
                                <!-- END OF Family -->
                                <h4 class="heading_b uk-margin-small-bottom ">Work Experience</h4>
                                ...
                                <h4 class="heading_b uk-margin-small-bottom ">Education</h4>
                                <div class="uk-overflow-container">
                                    <table class="uk-table uk-table-hover">
                                        <thead>
                                            <tr>
                                ...
                                <div id="spouse_div" <?php if($profile->emp_civilstatus == 'Married'){echo 'style="display:block;"';}else{echo 'style="display:none;"';}?>>
                                    <h4 class="heading_b uk-margin-small-bottom ">Spouse</h4>
                                    <ul class="md-list">
                                        <li>
                                            <div class="md-list-content">
                                                <span class="md-list-heading">
                                ...
                                <h4 class="heading_b uk-margin-small-bottom ">Dependents</h4>
                                <div class="uk-overflow-container">
                            ...
                            <li>
                                <h4 class="heading_b uk-margin-small-bottom ">Work</h4>
                                <ul class="md-list">
                                    <li>
                                        <div class="md-list-content">
                                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <hr/>
                                <h4 class="heading_b uk-margin-small-bottom ">Service Record</h4>
                                <div class="uk-overflow-container">
                            ...
                            <li>
                            <h4 class="full_width_in_card heading_a uk-text-bold uk-margin-small-bottom ">Leave Credit for <?php echo date('Y',strtotime("-1 year"));?></h4>
                                <table id="dt_pending" class="uk-table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                            <?php
                                                foreach($leave_credit_prev as $credit_prev){
                                                    echo '<tr>
                                                    <td>'.$credit_prev->leave_type.'</td>
                                                    <td>'.$credit_prev->days_consumed.'</td>
                                                    <td>'.$credit_prev->remaining_days.'</td>
                                                    <td>'.$credit_prev->emp_leave_credit.'</td>
                                                    </tr>';
                                                }
                                            ?>
                                    </tbody>
                            ...
                            <h4 class="heading_b uk-margin-small-bottom ">Leave History</h4>
                            ...
                            <li>
                            <h4 class="heading_b uk-margin-small-bottom ">201 Files</h4>
