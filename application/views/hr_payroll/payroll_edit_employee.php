                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <div class="uk-form-row">
                                                ...
                                                <input type="text" class="md-input uk-text-upper" name="emp_present_brgy" value="<?php echo $profile->emp_prese_brgy;?>" />
                                            ...
                                            <div class="uk-form-row">
                                                <label>Barangay</label>
                                                <input type="text" class="md-input uk-text-upper" name="emp_permanent_brgy" value="<?php echo $profile->emp_perma_brgy;?>" />
                                            ...
                                            if (is_array(unserialize(base64_decode($profile->emp_dep_LName))) && count(unserialize(base64_decode($profile->emp_dep_LName))) > 0 && unserialize(base64_decode($profile->emp_dep_LName))[0] != '') {
                                                ...
                                                for ($i = 0; $i < $exp; $i++) {
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td>
                                                                <input class="md-input uk-text-upper" type="text" name="dep_mname[]" placeholder="Middle Name" value="'.unserialize(base64_decode($profile->emp_dep_MName))[$i].'">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="md-input uk-text-upper" type="text" name="dep_bdate[]" data-uk-datepicker='."{format:'MM/DD/YYYY'}".' placeholder="MM/DD/YYYY" value="'.unserialize(base64_decode($profile->emp_dep_birthdate))[$i].'">
                                                            </td>
                                                        </tr>';
                                                }
                                            }
                                        ...
                                        if (is_array(unserialize(base64_decode($profile->record_position))) && count(unserialize(base64_decode($profile->record_position))) > 0 && unserialize(base64_decode($profile->record_position))[0] != '') {
                                            ...
                                            for ($i = 0; $i < $exp; $i++) {
                                                echo '<tr>
                                                        ...
                                                        <td>
                                                            <input class="md-input uk-text-upper" type="text" name="emp_inclusive_enddate[]" data-uk-datepicker="'."{format:'MM/DD/YYYY'}".'" placeholder="MM/DD/YYYY" value="'.unserialize(base64_decode($profile->record_enddate))[$i].'"/>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <select id="select_job_status" data-md-selectize name="emp_job_status[]">
                                                                ...
                                                                <optgroup label="Employment Status">
                                                                    ...
                                                                    <option value="Reliver">Reliever</option>
