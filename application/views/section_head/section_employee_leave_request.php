                                ...
                                <form enctype="multipart/form-data" method="POST" action="<?php echo base_url();?>Request-Leave-Function/<?php echo $employee_code;?>">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-6-10">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        ...
                                                        <input type="text" class="md-input uk-text-upper" name="form_leave_no_days" autocomplete="off" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        ...
                                                        <input class="md-input uk-text-upper" type="text" id="basic_birthdate" name="form_leave_sdate" data-uk-datepicker="{format:'MM/DD/YYYY'}" autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="uk-width-medium-1-2">
                                                    <div class="uk-form-row">
                                                        <label for="">To(MM/DD/YYYY)</label>
                                                        <input class="md-input uk-text-upper" type="text" id="basic_birthdate" name="form_leave_edata" data-uk-datepicker="{format:'MM/DD/YYYY'}" autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            <br/>
                                            <div class="uk-form-row">
                                                <label>Address</label>
                                                <input type="text" class="md-input uk-text-upper" name="form_leave_address" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
                                                <label>Reason</label>
                                                <input type="text" class="md-input uk-text-upper" name="form_leave_reason" autocomplete="off"/>
                                            </div>
                                            <div class="uk-form-row">
